...
<script>
  ...
  import {classfyChart, warnErrorChart, errorChart, classfyPie,errorPie,warnErrorPie} from '@/services/staticData/dAllHistoryVersion.js';
  export default {
    data() {
      return {
        classfyChart,
...
//      this.getRealData();
    ...
    methods: {
      ...
      async getClassfyData(){
        ...
        let data = {
          url: 'history/getAllDeviceAlertInfo',
          params: params,
          method: 'get',
          baseUrl: 'alert'
        };
      ...
      async getErrorData(){
        ...
        let data = {
          url: 'history/getAllDeviceErrorInfo',
          params: params,
          method: 'get',
          baseUrl: 'alert'
        };
      ...
      async getWarnErrorData(){
        ...
        let data = {
          url: 'history/getAllDeviceAlertorErrorInfo',
          params: params,
          method: 'get',
          baseUrl: 'alert'
        };
